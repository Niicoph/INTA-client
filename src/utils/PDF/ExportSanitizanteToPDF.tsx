...
export default async function ExportSanitizanteToPDF(
  Planes: Plan[],
  chartSanidad: SVGSVGElement
) {
  try {
    ...
    const tableProductBody = [
      [
        { text: 'Detalle de Productos', style: 'subheader', colSpan: 9, alignment: 'left' },
        {},
        {},
        {},
        {},
      ...
      ...Planes.flatMap((plan) =>
        plan.tratamientos.flatMap((tratamiento) =>
          tratamiento.aplicaciones.map((aplicacion) => [
            ...
            aplicacion.producto.dosis_x_hl,
            aplicacion.volumen_x_ha,
