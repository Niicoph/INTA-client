...
export const MaquinariaSchema = z.object({
  ...
  .min(0, 'Debe ser un valor entre 0 y 100')
  .max(100, 'Debe ser un valor entre 0 y 100'),

  id_implemento: z.string(),
  ...
  .min(0.001, 'Debe ser mayor que cero'),
});
