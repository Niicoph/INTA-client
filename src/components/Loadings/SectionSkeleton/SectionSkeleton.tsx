  ...
  return (
    <main className="flex flex-col  items-center w-full min-h-screen min-w-[350px] bg-background gap-4 p-4">
      <div className="w-full flex h-full flex-col justify-center items-center gap-4 md:max-w-3xl lg:max-w-4xl xl:max-w-5xl 2xl:max-w-[1400px]">
        <Skeleton className="rounded-md flex flex-col border border-border w-60 h-20 " />
        <Skeleton className="rounded-md flex flex-col border border-border h-14 w-full" />
