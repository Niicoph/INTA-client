...
import { PlanSchema } from '@/schemas/Fertilizacion/schema';
...
import { calcularCostoTotalFertilizacion } from '@/utils/costoTotalFertilizacion';
...
export default function FormPlan() {
  ...
  const handleFormSubmit = (data: PlanFormData) => {
    ...
    const finalFinalData = calcularCostoTotalFertilizacion(finalData);
